## 知识点总结
本章内容对应的[PPT1](../../PPT/第7章%20数值积分-第一次课-2026.pdf),[PPT2](../../PPT/第7章%20数值积分-第二次课-2026.pdf)，对应的代码：[数值积分方法.cpp](../../Code/数值积分方法.cpp) (Newton-Cotes, Romberg) 和 [Guass求积公式.py](../../Code/Guass求积公式.py) (Gauss-Legendre)
